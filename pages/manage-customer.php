...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="customer_address" name="customer_address" class="form-control" placeholder="CUSTOMER ADDRESS" readonly/> </div>
                            </div>
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="customer_email" name="customer_email" class="form-control" placeholder="CUSTOMER EMAIL" readonly/> </div>
                            </div>
...
<![endif]-->
         ...
         <?php
         if(isset($_SESSION['status']) && $_SESSION['status'] == DELETE_SUCCESSFULLY){
      ?>
      <script>
                  toastr.options = {
                    "closeButton": true,
      ...
      ?>
       ...
       <?php
         if(isset($_SESSION['status']) && $_SESSION['status'] == EDITED_SUCCESSFULLY){
      ?>
      <script>
                  toastr.options = {
                    "closeButton": true,
