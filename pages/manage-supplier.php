...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="supplier_address" name="supplier_address" class="form-control" placeholder="SUPPLIER ADDRESS" readonly/> </div>
                            </div>
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="supplier_email" name="supplier_email" class="form-control" placeholder="SUPPPLIER EMAIL" readonly/> </div>
                            </div>
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="gst_no" name="gst_no" class="form-control" placeholder="GST Number" readonly/> </div>
                            </div>
...
<![endif]-->
         ...
         <?php
         if(isset($_SESSION['status']) && $_SESSION['status'] == DELETE_SUCCESSFULLY_SUPPLIER){
      ?>
      <script>
                  toastr.options = {
                    "closeButton": true,
         ...
         toastr["success"]("You deleted successfully", "congrats!!")
      </script>
      <?php
      ...
      ?>
       ...
       <?php
         if(isset($_SESSION['status']) && $_SESSION['status'] == EDITED_SUCCESSFULLY_SUPPLIER){
      ?>
      <script>
                  toastr.options = {
                    "closeButton": true,
         ...
         toastr["success"]("You edited successfully", "congrats!!")
      </script>
      <?php
         unset($_SESSION['status']);
         }
