...
$columns = array("supplier.supplier_name", "supplier.supplier_address","supplier_email", "supplier_contact", "gst_no");
$query = "SELECT * FROM supplier HAVING supplier.deleted=0";

if(isset($_POST["search"]["value"])){
    $query .= " AND (supplier.supplier_name like '%".$_POST["search"]["value"]."%' OR supplier.supplier_contact OR supplier.supplier_email like '%". $_POST['search']['value']."%')";
}
