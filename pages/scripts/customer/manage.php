...
$columns = array("customer.customer_name", "customer.customer_address","customer_email", "customer_contact", "gst_no");
$query = "SELECT * FROM customer HAVING customer.deleted=0";

if(isset($_POST["search"]["value"])){
    $query .= " AND (customer.customer_name like '%".$_POST["search"]["value"]."%' OR customer.customer_contact OR customer.customer_email like '%". $_POST['search']['value']."%')";
}
