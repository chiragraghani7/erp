...
?>
   ...
   <head>
      <meta charset="utf-8" />
      <title>Quick ERP | Manage purchase</title>
            ...
            ?>
               ...
               <div class="page-content-wrapper">
                  ...
                  <div class="page-content">
                     ...
                     <!-- END PAGE BAR -->
                     <!-- BEGIN PAGE TITLE-->
                     <h3 class="page-title"> Manage purchase
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           ...
                           <i class="fa fa-list"></i> Add purchase</a>
                           </div>
                        </div>
                     </div>
                     <div class="row">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/purchase/edit.php" method="POST">
                        <div class="form-body">
                           <div class="form-group clearfix">
                                
                                <div class="col-md-9">
                                    <input type="hidden" id="edit_purchase_id" name="purchase_id" class="form-control" placeholder="purchase ID" /> </div>
                            </div>
                            <div class="form-group clearfix">
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="purchase_name" name="purchase_name" class="form-control" placeholder="purchase Name" /> </div>
                            </div>
                            <div class="form-group clearfix">
...
<span class="required"> * </span>
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="edit_save" name="edit_purchase" type="submit" class="btn btn-primary">Save changes</button>
                            </div>
...
<!--END OF EDIT BUTTON MODAL-->
          ...
          <span aria-hidden="true">&times;</span>
                                    ...
                                    <div class="modal-footer">
                                       <form action="http://localhost/erp/pages/scripts/purchase/delete.php" method="POST">
                                          <input type="hidden" id="recordID" name="purchase_id">
...
<![endif]-->
         ...
         <script src="../assets/pages/scripts/manage-purchase.js" type="text/javascript"></script>
