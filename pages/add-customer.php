    ...
    if(isset($_GET['q']))
{
    ...
    else if($_GET['q'] == 'error')
    {
         ...
         echo"<div class='alert alert-danger'>
            ...
            echo"<div class='alert alert-danger'>
                                            <button class='close' data-close='alert'></button> HSN code already present in gst table with different gst rate </div>";
...
?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                               <textarea name="customer_address" id="" cols="30" rows="5" placeholder="CUSTOMER ADDRESS" class="form-control"></textarea>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Gst Number<span class="required">  </span></label>
                                            <div class="col-md-4">
...
<![endif]-->
    ...
    <!--END OF CUSTOM SCRIPT LOADING-->
     ...
     <?php
         if(isset($_SESSION['status']) && $_SESSION['status'] == ERROR_INVALID){
      ?>
      <script>
                  toastr.options = {
                    "closeButton": true,
         ...
         toastr["warning"]("same contact number already exists", "same contact");
      </script>
      <?php
